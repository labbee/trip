...
export default function() {
    return [
        ...
        (function () {
            ...
            river.mask = mask
            river.addChild(
                new PIXI.extras.TilingSprite(PIXI.Texture.from('water'), width, height),
                new PIXI.extras.TilingSprite(PIXI.Texture.from('water'), width, height),
                mask
            )
        ...
        {
            texture: 'terrain.5.png',
            x: 2014, y: 633,
            rotation: .08
        },
        {
            texture: 'terrain.6.png',
            x: 2351, y: 657,
            rotation: .08
        },
        {
        ...
        (function () {
            const
                station = PIXI.Sprite.from('misc.17.png'),
                pillar = PIXI.Sprite.from('house.39.png'),
                shed = PIXI.Sprite.from('house.28.png'),
                bench = PIXI.Sprite.from('house.31.png'),
                ratio = 1.5
        ...
        (function () {
            const
                ship = PIXI.Sprite.from('dock.5.png')
        ...
        (function () {
            const
                wharf = PIXI.Sprite.from('dock.3.png')

            wharf.addChild(
                PIXI.Sprite.from('dock.7.png'),
                PIXI.Sprite.from('dock.9.png'),
                PIXI.Sprite.from('dock.6.png'),
                PIXI.Sprite.from('depot.9.png'),
                PIXI.Sprite.from('depot.9.png'),
                PIXI.Sprite.from('depot.9.png'),
                PIXI.Sprite.from('misc.7.png')
            )
        ...
        {
            texture: 'depot.17.png',
            rotation: -.25,
            x: 26009, y: 250,
            rotation: -.26,
        },
        {
            texture: 'terrain.44.png',
            rotation: -.25,
            x: 25792, y: 291,
            rotation: -.26,
        },
        {
            texture: 'terrain.45.png',
            rotation: -.25,
            x: 26791, y: 467,
            rotation: -1.7,
        },
        ...
        (function () {
            const
                bolt = PIXI.Sprite.from('terrain.27.png'),
                bell = PIXI.Sprite.from('terrain.24.png'),
                angle = {
                    v: 0,
                    a: 0,
                    max: .8,
        ...
        {
            texture: 'depot.16.png',
            x: 29406, y: -69,
            rotation: -.1,
            z: -1,
        },
        {
            texture: 'depot.15.png',
            x: 29311, y: -67,
            z: -1,
        },
        {
            texture: 'depot.13.png',
            x: 29302, y: -70,
            z: -1,
            rotation: -.1,
        },
