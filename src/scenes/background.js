...
export default function(core, resource) {
    ...
    return [
        ...
        {
            texture: tree.textures['tree.3.png'],
            x: 13776, y: 558,
            z: -5,
            alpha: .6,
            scale: .7,
        ...
        {
            texture: house.textures['house.21.png'],
            x: 13954, y: 588,
        },
        {
            texture: tree.textures['tree.3.png'],
        ...
        {
            texture: house.textures['house.22.png'],
            x: 14134, y: 666,
        },
        {
            texture: house.textures['house.40.png'],
        ...
        {
            texture: house.textures['house.38.png'],
            x: 14897, y: 640,
            drag: true
        },
        {
            texture: terrain.textures['terrain.20.png'],
            x: 14914, y: 707,
        },
        {
            texture: tree.textures['tree.20.png'],
        ...
        {
            texture: house.textures['house.31.png'],
            x: 14962, y: 709,
        },
        {
        ...
        {
            texture: misc.textures['misc.14.png'],
            x: 15884, y: 364,
        },
        {
            texture: tree.textures['tree.20.png'],
        ...
        {
            texture: house.textures['house.16.png'],
            x: 16339, y: 628,
        },
        {
            texture: tree.textures['tree.5.png'],
        ...
        {
            texture: tree.textures['tree.15.png'],
            x: 16899, y: 489,
        },
        {
            texture: tree.textures['tree.2.png'],
        ...
        {
            texture: house.textures['house.18.png'],
            x: 16794, y: 655,
        },
        {
            texture: terrain.textures['terrain.47.png'],
        ...
        {
            texture: terrain.textures['terrain.22.png'],
            x: 17818, y: 670,
        },
        {
            texture: terrain.textures['terrain.32.png'],
            x: 17873, y: 700,
        },
        {
            texture: tree.textures['tree.16.png'],
        ...
        {
            texture: house.textures['house.17.png'],
            x: 19838, y: 709,
        },
        {
            texture: tree.textures['tree.5.png'],
        ...
        /* 植树占位符 */
        {
            texture: house.textures['house.5.png'],
            x: 20138, y: 603,
        },
        {
            texture: house.textures['house.9.png'],
            x: 20140, y: 665,
        },
        {
            texture: house.textures['house.36.png'],
        ...
        {
            texture: house.textures['house.15.png'],
            x: 20418, y: 673,
        },
        {
            texture: house.textures['house.42.png'],
            x: 20416, y: 611,
        },
        {
            texture: house.textures['house.5.png'],
        ...
        {
            texture: misc.textures['misc.18.png'],
            x: 21308, y: 527,
        },
        {
            texture: house.textures['house.5.png'],
        ...
        (function() {
            ...
            for (let i = 0; i < 4; i++) {
                const leaf = new PIXI.Sprite(house.textures['house.32.png'])
        ...
        {
            texture: house.textures['house.24.png'],
            x: 23328, y: 525,
            z: -6,
            alpha: .6,
            scale: .6,
        ...
        {
            texture: misc.textures['misc.12.png'],
            x: 23079, y: 372,
            z: -6,
            alpha: .6,
            scale: .6,
        ...
        {
            texture: terrain.textures['terrain.34.png'],
            x: 29108, y: -428,
        },
        {
            texture: terrain.textures['terrain.25.png'],
            x: 29264, y: -79,
            z: -2,
        },
        {
        ...
        {
            texture: terrain.textures['terrain.30.png'],
            x: 28862, y: -60,
        },
        {
            texture: terrain.textures['terrain.7.png'],
            x: 28790, y: -37,
            drag: true
        },
        {
        ...
        {
            texture: terrain.textures['terrain.38.png'],
            x: 28975, y: -107,
            scale: .7,
        },
        {
            texture: terrain.textures['terrain.26.png'],
            x: 29056, y: -198,
            scale: .7,
        },
        {
            texture: terrain.textures['terrain.28.png'],
            x: 28300, y: -10,
        },
        {
            texture: tree.textures['tree.12.png'],
        ...
        {
            texture: depot.textures['depot.10.png'],
            x: 27451, y: -130,
        },
        {
            texture: depot.textures['depot.10.png'],
        ...
        {
            texture: house.textures['house.37.png'],
            x: 27451, y: -78,
        },
        {
            texture: house.textures['house.6.png'],
            x: 27347, y: 10,
        },
        {
            texture: misc.textures['misc.7.png'],
        ...
        {
            texture: house.textures['house.27.png'],
            x: 27258, y: -12,
        },
        {
